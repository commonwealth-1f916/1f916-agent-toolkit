...
Status: `queue/prompt-batch-2026-W40` (rev. 2026-09-23; close-check 7 and rule 2's pin, the second to fourth revisions of this doc in the 2026-09-21/23 sitting, recorded on the runs rows). The one document every run and sitting reads before acting: map, standing rules, pointers. No state, no narrative, no secrets.
